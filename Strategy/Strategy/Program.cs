...
namespace Strategy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] arr3 = { 1, 5, 10, 2, 4, 4, 14, 10, 12, 17 };
            sort = new BubbleSort();
            ...
            //Спомоью паттерна Стратегия были реализованы 3 сортировки в зависимости от сортируемых данных 
            //с целью эффективного использования аппаратных ресурсов.
